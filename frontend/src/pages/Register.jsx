  ...
  return (
    <div className="auth-page">
      <form className="card auth-card" onSubmit={reg}>
        ...
        {msg && <div className="success" data-testid="register-success">{msg}</div>}
        <>
            ...
            <input name="password" type="password" placeholder="Password (min 8 characters)" onChange={up} required minLength={8} />
